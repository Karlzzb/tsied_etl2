...
public class SearchResult {
	...
	public SearchResult(SearchResponse resp, Select select) {
	 ...
	 * @return @
	 */
	private Map<String, Object> toAggsMap(Map<String, Aggregation> fields) {
		Map<String, Object> result = new HashMap<>();
	...
	private Object covenValue(Aggregation value) {
